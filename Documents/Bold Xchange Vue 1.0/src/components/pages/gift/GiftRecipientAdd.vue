      ...
      <div class="page-header">
        <div class="row align-items-center">
          <div class="col-sm mb-2 mb-sm-0">
            ...
            <h1 class="page-header-title">Add recipient</h1>
          </div>
          <!-- End Col -->
        </div>
        <!-- End Row -->
            ...
            <div class="card-body">
              ...
              <div id="addAddressFieldTemplate" style="display: none">
                <div class="input-group-add-field">
                  ...
                  <a
                    class="js-delete-field input-group-add-field-delete"
                    href="javascript:;"
                  >
                    <i class="bi-x"></i>
                  </a>
              ...
              <div class="form-check mb-4">
                ...
                />
                <label class="form-check-label" for="marketingEmailsCheckbox"
                  >I want to receive promotions, announcements, and marketing
                  emails.</label
                >
              </div>
              <!-- End Form Check -->
            ...
            <div class="card-body">
              <div class="row">
                <div class="col-sm-6">
                  <!-- Form -->
                  <div class="mb-4">
                    <label for="firstNameAddressLabel" class="form-label"
                      >First name</label
                    >
                    <input
                      type="text"
                ...
                <div class="col-sm-6">
                  <!-- Form -->
                  <div class="mb-4">
                    <label for="lastNameAddressLabel" class="form-label"
                      >Last name</label
                    >
                    <input
                      type="text"
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="addressLocationLabel" class="form-label"
                  >Location</label
                >
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="AddressLine1Label" class="form-label"
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="AddressLine2Label" class="form-label"
                  >Address line 2
                  <span class="form-label-secondary">(Optional)</span></label
                >
                <input
              ...
              <!-- Form -->
              <div class="mb-4">
                <label for="addresszipCodeLabel" class="form-label"
                  >Zip code
                  <i
