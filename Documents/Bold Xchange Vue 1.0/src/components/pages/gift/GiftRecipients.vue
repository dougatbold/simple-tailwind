    ...
    <div class="content container-fluid">
      ...
      <div class="page-header">
        <div class="row align-items-center mb-3">
          <div class="col-md mb-2 mb-md-0">
            <h1 class="page-header-title">Gift Recipients</h1>

            <div class="d-sm-flex mt-2">
              <a
                class="d-inline-block text-body mb-2 mb-sm-0 me-3"
                href="javascript:;"
                data-bs-toggle="modal"
                data-bs-target="#importCustomersModal"
              >
                <i class="bi-upload me-1"></i> Import recipients
              </a>
              <a
                class="d-inline-block text-body mb-2 mb-sm-0 me-3"
                href="javascript:;"
                data-bs-toggle="modal"
                data-bs-target="#exportCustomersModal"
              >
          ...
          <div class="col-md-auto">
            <a class="btn btn-primary" href="./gift-recipient-add.html"
              >Add gift recipient</a
            >
          </div>
          <!-- End Col -->
        </div>
      ...
      <div class="card">
        ...
        <div class="card-header card-header-content-sm-between">
          ...
          <div
            class="d-grid d-sm-flex justify-content-sm-end align-items-sm-center gap-2"
          >
            <!-- Datatable Info -->
                ...
                <div class="card card-sm">
                  <div class="card-body">
                    <div class="d-grid gap-3">
                      ...
                      <label
                        class="row form-check form-switch"
                        for="toggleColumn_postal_code"
                      >
                        <span class="col-8 col-sm-9 ms-0">
                          <span class="me-2">Postal Code</span>
                        </span>
                        <span class="col-4 col-sm-3 text-end">
                          <input
                            type="checkbox"
                            class="form-check-input"
                            id="toggleColumn_postal_code"
                            checked
                          />
                        </span>
                      </label>
                      ...
                      <label
                        class="row form-check form-switch"
                        for="toggleColumn_last_activity"
                      >
                        <span class="col-8 col-sm-9 ms-0">
              ...
              <tr>
                ...
                <td class="table-column-ps-0">
                  <a
                    ...
                    href="./gift-recipient-details.html"
                  >
...
export default {
  name: "GiftRecipients",
  data() {
    return { img3, img4, img5, img6, img7, img8, img9, img10 };
  },
};
</script>
